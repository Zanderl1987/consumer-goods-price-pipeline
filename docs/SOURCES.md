...
| **WFP Global Food Prices (HDX)** | Keyless — https://data.humdata.org/dataset/wfp-food-prices | **NEW FIND (not in original plan).** Retail/wholesale food prices, 76 countries, 1,500+ markets, weekly. The updateable upstream of the stale Kaggle mirror | Weekly | Strongest free updateable international retail-food feed. **NEW: recommend adding** |
